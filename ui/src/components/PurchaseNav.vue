<template>
  <div class="list-group list-group-flush">
    ...
    <router-link to="/purchase/reimburse" class="list-group-item" v-bind:class="{reimburse:current.complete}" v-if="auth_state.viewTreasurer">Reimburse Purchase</router-link>
