<template>
  <div>
    ...
    <p class="lead">Below are all reimbursed purchases for IEEE.</p>
    ...
    <DataTable
      ...
      v-bind:row_headers="[['Date','date'],['Item','item'],['Vendor','vendor'],['Committee','committee'],['Purchaser','purchasedby'],['Amount','cost'],['Status','status']]"
    >
